...
public class GerenciarEspecialistaUI extends javax.swing.JFrame implements UIGerenciarEspecialista {
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if (clickMouse == 2) {
            ...
            DoctorEstetica doctorEstetica = (DoctorEstetica) especialista;
            doctorEsteticaAtual = doctorEstetica;
    ...
    public void cadastrarEspecialista() {
        ...
        Especialista doctorEstetica = new DoctorEstetica(crmv, gerenciarEspecialidade.listagem().get(index), nome, cpf);
        try {
            gerenciarEspecialista.cadastrarEspecialista(doctorEstetica);
